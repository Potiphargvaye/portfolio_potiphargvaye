    ...
    <div class="container footer-top">
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-md-3 footer-links">
          <h4>Useful Links</h4>
          <ul>
            <li><i class="bi bi-chevron-right"></i> <a href="404.php">Home</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="404.php">About us</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="404.php">Services</a></li>
